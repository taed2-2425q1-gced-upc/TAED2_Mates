...
def mock_tf_components(mocker):
    ...
    mock_hub_keras_layer = mocker.patch('mates.features.features.hub.KerasLayer',
                                         new_callable=mock.Mock)
    mock_add = mocker.patch('mates.features.features.tf_keras.Sequential.add',
                             new_callable=mock.Mock)
    mock_dense = mocker.patch('mates.features.features.tf_keras.layers.Dense',
                               new_callable=mock.Mock)
    mock_adam = mocker.patch('mates.features.features.tf_keras.optimizers.Adam',
                              new_callable=mock.Mock)
    mock_sgd = mocker.patch('mates.features.features.tf_keras.optimizers.SGD',
                             new_callable=mock.Mock)
