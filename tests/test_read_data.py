""" Module to test function read_data from features """
...
def mock_file_operations(mocker):
    ...
    # Mock pd.read_csv to return the mock train data
...
def test_read_data_with_training_data(mock_file_operations):
    """
    Test for function read_data with training data
    """
...
def test_read_data_with_test_data(mock_file_operations):
    """
    Test for function read_data with test data
    """
    # pylint: disable=unused-argument
    # Given
    mock_dir_path = Path('/mock/path')

    # Call the function with train_data=False
